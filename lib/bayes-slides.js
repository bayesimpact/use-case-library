...
(function () {
  ...
  S.cover = function (o) {
    o = o || {};
    var eyeRaw = L(o, "eyebrow");
    var eye = pair(eyeRaw, "Bayes Platform", "Bayes Platform");
    var showEye = !(eyeRaw && !eyeRaw.fr);   // pass {"fr":"","en":""} to hide it
    ...
    return '<section class="slide dark cover" id="cover" data-dark>' +
      '<div class="slide-inner">' +
        ...
        (showEye ? '<p class="eyebrow reveal">' + eye + "</p>" : "") +
